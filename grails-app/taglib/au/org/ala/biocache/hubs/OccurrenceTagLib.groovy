            ...
            p(class: 'rowA') {
                ...
                if (occurrence.raw_catalogNumber != null && occurrence.raw_catalogNumber) {
                    span(style: 'display:inline-block;float:right;') {
                        strong(class: 'resultsLabel') {
                            mkp.yieldUnescaped("${message(code: 'occurrence.catalogueNumber')}: ")
                        }
                ...
                span(class: 'eventAndLocation') {
                    if (occurrence.eventDate) {
                        outputResultsLabel("${message(code: 'occurrence.date')}: ", g.formatDate(date: new Date(occurrence.eventDate), format: "dd-MM-yyyy"), true)
                ...
                span(class: 'avhRowB') {
                    ...
                    outputResultsLabel("${message(code: 'occurrence.decimalLatitude')}: ", alatag.message(code: occurrence.decimalLatitude), occurrence.decimalLatitude)
                    outputResultsLabel("${message(code: 'occurrence.decimalLongitude')}: ", alatag.message(code: occurrence.decimalLongitude), occurrence.decimalLongitude)
                }
                ...
                tr() {
                    td(colspan: '3', style: 'text-align: right;') {
                        ...
                        a(
                                ...
                                style: "margin-left: 15px; text-decoration: underline;",
