...
<head>
    ...
    <title><g:message code="home.index.title" default="Biodiversity Information System"/> | ${hubDisplayName}</title>
...
<body>
    <div id="headingBar" class="heading-bar">
        <h1 style="width:100%; color: #0081c6" id="searchHeader"><g:message code="home.index.body.title" default="Biodiversity Information System"/> ${raw(hubDisplayName)}</h1>
        <p><g:message code="home.index.body.title.description" default="The goal of this System is, to show to the user the possibility to publish his own database applying the standards of Darwin core and Darwin core Archive, and in this way, users can search, filter, use and analyze the contained data, and for sure to share the information with the rest of the community."/></p>
    </div>
        ...
        <ul class="thumbnails">
            <li class="span4">
                <div class="thumbnail">
                    ...
                    <div class="caption">
                        <h3><g:message code="home.index.title.one" default="Registry"/></h3>
                        <p><g:message code="home.index.one.description" default="Through this Registry you can read all information related with Institutions and Collections, that have been registered. You can also analyze statistical data and search their associated records."/></p>
                        <p><a href="/collectory" class="btn btn-primary"><g:message code="home.index.btn.view" default="View"/></a>
                    </div>
                </div>
            </li>
            <li class="span4">
                <div class="thumbnail">
                    ...
                    <div class="caption">
                        <h3><g:message code="home.index.title.two" default="List of Databases"/></h3>
                        <p><g:message code="home.index.two.description" default="You can filter the databases that there are in the System according to the defined labels, you can also read the metadata of resources, view its page, charts, rights, citations, coverages, descriptions..."/></p>
                        <p><a href="/collectory/datasets" class="btn btn-primary"><g:message code="home.index.btn.view" default="View"/></a>
                    </div>
                </div>
            </li>
            <li class="span4">
                <div class="thumbnail">
                    ...
                    <div class="caption">
                        <h3><g:message code="home.index.title.three" default="Search by Area"/></h3>
                        <p><g:message code="home.index.three.description" default="Do you want to search the records in your location, through one address or typing the coordinates?. You can adjust the action range, and you can obtain the taxonomic information related to the records that there are located in that location."/></p>
                        <p><a href="/generic-hub/explore/your-area?default=true" class="btn btn-primary"><g:message code="home.index.btn.view" default="View"/></a></p>
                    </div>
                </div>
            </li>
        </ul>
    ...
    <div>
        <u><h3 style="text-align: center; color: #0081c6"><g:message code="home.index.sub.title" default="You can query the records through different kinds of searches"/></h3></u>
    </div>
