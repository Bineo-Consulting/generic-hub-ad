...
<g:else>
    ...
    <li id="dataQualityFurtherDetails">
        <i class="icon-flag"></i>&nbsp;
        <a href="mailto:gbif@andorra.ad?subject=${g.message(code:'feedback.subject')}"><g:message code="show.button.assertionbutton.span"/></a>
    </br>
        <span style="color:grey;font-size:10px">(email > gbif@andorra.ad)</span>
    </li>
</ul>
