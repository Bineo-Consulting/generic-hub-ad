...
<!-- Sampling Protocol -->
    <alatag:occurrenceTableRow annotate="true" section="dataset" fieldCode="samplingProtocol" fieldName="${message(code:'recordcore.occurrencedatasetlabel.75')}">
...
<alatag:occurrenceTableRow annotate="true" section="geospatial" fieldCode="latitude" fieldName="${message(code:'recordcore.occurrencedatasetlabel.52')}">
    ...
    <g:if test="${clubView && record.raw.location.decimalLatitude != record.processed.location.decimalLatitude}">
        ...
        <g:if test="${record.raw.location.decimalLatitude.take(1) == '-'}"> <span><g:message code="recordcore.occurrencedatasetlabel.52.S" default="South"/></span>
        </g:if>
        <g:else>
            <span><g:message code="recordcore.occurrencedatasetlabel.52.N" default="North"/></span>
        </g:else>
    </g:if>
    <g:elseif test="${record.raw.location.decimalLatitude && record.raw.location.decimalLatitude != record.processed.location.decimalLatitude}">
        ...
        <g:if test="${record.processed.location.decimalLatitude.take(1) == '-'}"> <span><g:message code="recordcore.occurrencedatasetlabel.52.S" default="South"/></span>
        </g:if>
        <g:else>
            <span><g:message code="recordcore.occurrencedatasetlabel.52.N" default="North"/></span>
        </g:else>
            <br/><span class="originalValue"><g:message code="recordcore.occurrencedatelabel.08" default="Supplied as"/>: "${record.raw.location.decimalLatitude}"</span>
                            <g:if test="${record.raw.location.decimalLatitude.take(1) == '-'}"> <span><g:message code="recordcore.occurrencedatasetlabel.52.S" default="South"/></span>
        </g:if>
        <g:else>
            <span><g:message code="recordcore.occurrencedatasetlabel.52.N" default="North"/></span>
    ...
    <g:elseif test="${record.raw.location.decimalLatitude} == null">
        <span>0.0</span>
    </g:elseif>
</alatag:occurrenceTableRow>
<!-- Longitude -->
<alatag:occurrenceTableRow annotate="true" section="geospatial" fieldCode="longitude" fieldName="${message(code:'recordcore.occurrencedatasetlabel.53')}">
    ...
    <g:if test="${clubView && record.raw.location.decimalLongitude != record.processed.location.decimalLongitude}">
        ...
        <g:if test="${record.raw.location.decimalLongitude}.take(1) == '-'"> <span><span><g:message code="recordcore.occurrencedatasetlabel.53.W" default="West"/></span>
            </g:if>
        <g:else>
            <span><g:message code="recordcore.occurrencedatasetlabel.53.E" default="East"/></span>
        </g:else>
    ...
    <g:elseif test="${record.raw.location.decimalLongitude && record.raw.location.decimalLongitude != record.processed.location.decimalLongitude}">
        ...
        <g:if test="${record.processed.location.decimalLongitude}.take(1) == '-'"> <span><g:message code="recordcore.occurrencedatasetlabel.53.W" default="West"/></span>
        </g:if>
        <g:else>
            <span><g:message code="recordcore.occurrencedatasetlabel.53.E" default="East"/></span>
        </g:else>
        <br/><span class="originalValue">Supplied as: "${record.raw.location.decimalLongitude}"</span>
        <g:if test="${record.raw.location.decimalLongitude}.take(1) == '-'"> <span><g:message code="recordcore.occurrencedatasetlabel.53.W" default="West"/></span>
        </g:if>
        <g:else>
            <span><g:message code="recordcore.occurrencedatasetlabel.53.E" default="East"/></span>
        </g:else>
    ...
    <g:elseif test="${record.raw.location.decimalLongitude} == null">
        <span>0.0</span>
    </g:elseif>
    ...
    <div id="additionalProperties">
        ...
        <table class="occurrenceTable table table-bordered table-striped table-condensed" id="miscellaneousPropertiesTable">
            ...
            <g:each in="${record.raw.miscProperties.sort()}" var="entry">
                ...
                <g:if test="${entry.key == 'datasetKey'}">
                    <alatag:occurrenceTableRow annotate="true" section="geospatial" fieldCode="${entry.key}" fieldName='${message(code: addproplabel)}'><a href="http://www.gbif.org/dataset/${entry.value}">http://www.gbif.org/dataset/${entry.value}</a> </alatag:occurrenceTableRow>
                </g:if>
                <g:if test="${entry.key == 'gbifID'}">
                    <alatag:occurrenceTableRow annotate="true" section="geospatial" fieldCode="${entry.key}" fieldName='${message(code: addproplabel)}'><a href="http://www.gbif.org/occurrence/${entry.value}">http://www.gbif.org/occurrence/${entry.value}</a> </alatag:occurrenceTableRow>
                </g:if>
                <g:if test="${entry.key == 'publishingOrgKey'}">
                    <alatag:occurrenceTableRow annotate="true" section="geospatial" fieldCode="${entry.key}" fieldName='${message(code: addproplabel)}'><a href="http://www.gbif.org/publisher/${entry.value}">http://www.gbif.org/publisher/${entry.value}</a> </alatag:occurrenceTableRow>
                </g:if>
                <g:if test="${entry.key == 'speciesKey'}">
                    <alatag:occurrenceTableRow annotate="true" section="geospatial" fieldCode="${entry.key}" fieldName='${message(code: addproplabel)}'><a href="http://www.gbif.org/species/${entry.value}">http://www.gbif.org/species/${entry.value}</a> </alatag:occurrenceTableRow>
                </g:if>
                <g:if test="${entry.key == 'taxonKey'}">
                    <alatag:occurrenceTableRow annotate="true" section="geospatial" fieldCode="${entry.key}" fieldName='${message(code: addproplabel)}'><a href="http://www.gbif.org/species/${entry.value}">http://www.gbif.org/species/${entry.value}</a> </alatag:occurrenceTableRow>
                </g:if>
