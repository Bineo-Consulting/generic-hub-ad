    ...
    <div class="sidebar" style="float:left;">
        ...
        <div id="loginOrFlag" class="modal hide" tabindex="-1" role="dialog" aria-labelledby="loginOrFlagLabel" aria-hidden="true"><!-- BS modal div -->
            ...
            <div class="modal-body">
                <g:if test="${!userId}">
                    <div style="margin: 20px 0;"><g:message code="show.button.assertionbuton.title" default="report a problem or suggest a correction for this record:"/>
                        <a href="mailto:gbif@andorra.ad?subject=${g.message(code:'feedback.subject')}"><g:message code="show.loginorflag.div01.navigator" default="Click here"/></a>
                    </div>
                </g:if>
                <g:else>
                    <div>
